...
class GitHubClient:
    ...
    async def fetch_repo_runs(
        ...
        match status_code:
            case 200:
                    ...
                    workflow_runs.append(
                        WorkflowRun(
                            ...
                            triggering_actor={
                                ...
                                "avatar_url": run_data["triggering_actor"][
                                    "avatar_url"
                                ],
                            },
                ...
                print(f"Fetched {len(workflow_runs)} runs for {repo_name}")
                print(*workflow_runs, sep="\n")
    ...
    async def check_rate_limit(self) -> dict:
        ...
        # TODO: Call /rate_limit endpoint
        # Return {"remaining": X, "reset": timestamp}
        url = f"{self.base_url}/rate_limit"

        core_rate_limit = {"remaining": None, "reset": None}
        status_code = None
        response = None
        ...
        match status_code:
            case 200 | 304:
                ...
                if "core" in resources_data:
                    ...
                    core_rate_limit["remaining"] = core_data.get("remaining")
                    core_rate_limit["reset"] = core_data.get("reset")
